# 💫 About Me:
Hi, I'm a **Computer Engineer** with a passion for both **low-level** systems. I enjoy working across the stack, from deep down in the hardware layer with **assembly** and architectures like **RISC-V** and **ARM**, also worked on building complex applications using _machine learning_ and _web development_ frameworks.
